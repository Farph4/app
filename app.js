    ...
    <div class="tab-content">
      ...
      <div class="balance-card">
        ...
        <div class="balance-amount">
          ...
          <span class="balance-value">${totalDeposits.toFixed(2)}</span>
        </div>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-info">
            <span class="stat-label">Depósitos Totales</span>
    ...
    <div class="tab-content">
      <div class="section-header">
        ...
        <div class="section-filters">
          ...
          <button class="filter-btn">Depósitos</button>
          <button class="filter-btn">Retiros</button>
          <button class="filter-btn">Trading</button>
        </div>
      </div>
      <div class="empty-state">
        ...
        <h2 class="empty-title">No hay transacciones que mostrar</h2>
        <p class="empty-text">
          Tus transacciones aparecerán aquí una vez que realices operaciones, depósitos o retiros en tu cuenta.
        </p>
      </div>
    </div>`;
}
